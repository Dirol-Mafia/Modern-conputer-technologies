...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ImageProvider_t, stringdata) + ofs \
...
const QMetaObject ImageProvider::staticMetaObject = {
    { &QAbstractItemModel::staticMetaObject, qt_meta_stringdata_ImageProvider.data,
      qt_meta_data_ImageProvider,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ImageProvider.stringdata))
